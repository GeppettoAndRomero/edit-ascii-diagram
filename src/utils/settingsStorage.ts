/**
 * localStorage persistence for editor settings (the draft diagram text + the
 * import baseline used by the D14 "copy for AI" export).
 */

import { DEFAULT_SETTINGS, normalizeSettings, type EditorSettings } from './settings';

const STORAGE_KEY = 'edit-ascii-diagram-settings';
