...
const PRECACHE_URLS = [
  '/edit-ascii-diagram/',
  '/edit-ascii-diagram/manifest.json',
  '/edit-ascii-diagram/icon-192.png',
  '/edit-ascii-diagram/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/edit-ascii-diagram/manifest.json';
}
